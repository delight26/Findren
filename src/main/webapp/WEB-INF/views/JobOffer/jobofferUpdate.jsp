...
<div class="container bodymargin">
	...
	<div class="row">
		...
		<form id="frm" action="jobofferUpdateResult" method="post" enctype="multipart/form-data">
			<table class="table inputForm">
				<tr>
					<td>옵션</td>
					<td>
						<input type="checkbox" value="joboffer" name="type"/>공지
						<input type="hidden" value="${ joboffer.wr_id }"  name="no"/>
					</td>
				</tr>
				<tr>
					<td>제목</td>
					<td><input type="text" name="title" value="${ joboffer.wr_subject }"/></td>
				</tr>
			   	<tr>
			   		<td>내용</td>
			   		<td id="input"><textarea name="content" id="ir1" rows="10" cols="100">${ joboffer.wr_content }</textarea></td>
				<tr>
					<td>링크 1</td>
					<td><input type="text" name="link1" value="${ joboffer.wr_link1 }"/></td>
				</tr>
				<tr>
					<td>링크 2</td>
					<td><input type="text" name="link2"/>${ joboffer.wr_link2 }</td>
				</tr>
				<tr>
					<td>파일 1</td>
