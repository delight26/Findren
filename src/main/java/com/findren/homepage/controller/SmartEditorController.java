...
import com.findren.homepage.service.impl.SmartEditorService;
...
public class SmartEditorController {
	...
	public String photoUpload(HttpServletRequest request, SmartEditorService vo) {
		...
		try {
			if (vo.getFiledata() != null && vo.getFiledata().getOriginalFilename() != null
				...
				file_result += "&bNewLine=true&sFileName=" + original_name + "&sFileURL=../photo_upload/"
						+ realname;
			} else {
